...
CkWordeditor is a WYSIWYG text editor designed with the help of Ckeditor to simplify word document creation. This gem allows you to paste content from Microsoft Word and maintain original content formatting. It uploads the images present on the Microsoft Word automatically to server.
[ckeditor.com](http://ckeditor.com/)

## Features

* CKEditor version 4.10.0 full (03 July 2018)
...
For basic usage just include the ckwordeditor gem:
...
```
gem 'ckwordeditor', github: 'ashishprajapati/ckwordeditor'
```
...
### User Ckeditor as the Word Interface that allow Pasting content from Microsoft Word
This gem allows you to paste content from Microsoft Word and maintain original content formatting. It uploads the images present on the Microsoft Word automatically. You can use 'ckword' either as class or as rel attribute. It will automatically load the word interface for you. It's very much simple to integrate. 

```rails
= text_area_tag :content, nil, class: "ckword"
= text_area_tag :content, nil, rel: "ckword"
```

### User Ckeditor general interface

```rails
= text_area_tag :content, nil, class: "ckeditor"
```
...
Ckeditor.setup do |config|
  ...
  config.cdn_url = "//cdn.ckeditor.com/4.10.0/full-all/ckeditor.js"
end
```
